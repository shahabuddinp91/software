...
//                                            echo $searching_item;
                                            $select_query_id = "SELECT * FROM `patient_test_info` WHERE reg_id='$searching_item'";
...
//                                            die();
                                            ...
                                            $select_query_name = "SELECT * FROM `patient_test_info` WHERE patient_name='$searching_item'";
//                                            echo $select_query_name;
//                                            die();
                                            $execute_name = $conn->query($select_query_name);
                                            $count_name = mysqli_num_rows($execute_name);

                                            $select_query_mobile = "SELECT * FROM `patient_test_info` WHERE date='$searching_item'";
...
//                                                    die();
                                        ...
                                        <div class="panel panel-primary modal-content modal-body col-md-8" style="">
                                            <div class="panel-heading" align="center">Total Test Bill</div>
                                            <br>
                                            <form class="form-horizontal form-group-sm patient_test_total_bill" role="form" action="" method="post">
                                                ...
                                                <?php
                                                    $info_select = "SELECT * FROM `diagonostic_patient_bill` WHERE regi_id = '$patient_id'";
