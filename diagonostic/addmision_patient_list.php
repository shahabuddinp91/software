            ...
            <div class="body_area" style="min-height: 700px;">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="right_content_area" style="margin-left: -100px;">
                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                <?php echo 'All Addmission Patient at ' . $today ?>

                                            </h2>



                                            <form action="addmission_patient_search.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
                                                        <td><input style="text-align: center;font-size: 12px;width: 300px;" type="text"  name="selldate" id="selldate"  class="form-control datepicker" placeholder="Search By Date,ID & Mobile !" required></td>
...
//echo $today;
                                            ...
                                            $select_sql = "select patient_entry_form.patient_name,patient_entry_form.id,patient_entry_form.mobile,patient_admission_system.reg_id ,patient_admission_system.cabin_no,patient_admission_system.admission_date,patient_admission_system.doctor_name,patient_admission_system.madical_problem,patient_admission_system.admission_fee,patient_admission_system.admission_payment,patient_admission_system.admission_due from patient_entry_form inner join patient_admission_system on patient_entry_form.id=patient_admission_system.reg_id where admission_date = '$today' ORDER BY reg_id DESC ";
