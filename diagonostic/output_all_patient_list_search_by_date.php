                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                $select_query = "SELECT * FROM `patient_entry_form` WHERE reg_date='$searching_date' and status = '1'";
//                                                    echo $select_query;
//                                                    die();
                                                $execute_sql = $conn->query($select_query);
                                                $sell_date_count = mysqli_num_rows($execute_sql);

                                                $select_query = "SELECT * FROM `patient_entry_form` WHERE id='$searching_date' and status = '1'";
                                                $sele = $conn->query($select_query);
                                                $count = mysqli_num_rows($sele);

                                                $select_query_mobile = "SELECT * FROM `patient_entry_form` WHERE mobile ='$searching_date' and status = '1'";
