                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dashboard_text text-center">
                                ...
                                <br>
                                Dashboard Of Reception Desk (Hospital)
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="right_content_area">
                            <div class="col-md-10">
                                <form action="output_indoor_report_message.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                    <table border="0" >
                                        <tr>
                                ...
                                $today = date('m/d/Y');
                                ?>
                                <p style="color: red;font-size: 29px;">All Indoor Test Report For <?php echo $today; ?></p>
                                <table id="hide" border="1" class="table text-center" style="margin-top: 10px;">
                                    ...
                                    $today = date('m/d/Y');
                                    $patient_message = '';
                                    $select_query = "SELECT * FROM `indoor_path_message` WHERE date = '$today' and status = 'Report ok' ORDER BY id DESC";
//                                  
                                    ...
                                    if ($count > 0) {
                                        ...
                                        while ($row = $execute_sql->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="report_indoor_test_list.php?patient_id=<?php echo $row['patient_id']; ?>"><img src="../images/view.png" width="30" height="30" title="View" alt="View" style="padding: 2px;"></a> | 
                                                    <a style="cursor : pointer;" class="raju" valu="<?php echo $row['test_name']; ?>" value="<?php echo $row['test_catagory']; ?>" user_id = "<?php echo $row['patient_id']; ?>">It's ok</a>
