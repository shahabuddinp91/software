...
//                                    echo $searching_date;
//                                    die();
                                        $select_query = "SELECT * FROM `indoor_path_message` where status = 'REPORT OK RECEPTION ADMIN RECEIVED IT.' and date='$searching_date'";
//                                        echo $select_query;
//                                        die();
                                        $execute_sql = $conn->query($select_query);
                                        $sell_date_count = mysqli_num_rows($execute_sql);
                                        
                                        $select_query_id="SELECT * FROM `indoor_path_message` where status = 'REPORT OK RECEPTION ADMIN RECEIVED IT.' and patient_id='$searching_date'";
