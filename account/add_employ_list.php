                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                <?php echo 'All employee list !'; ?>

                                            </h2>



                                            <form action="search_employ.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
...
//echo $today;
                                            ...
                                            $select_sql = "SELECT * FROM `add_person` ";
