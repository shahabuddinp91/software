...
$check = $_POST['check'];
    ...
    if(!$check){
       ...
       $sub_total =  ($ot_dresing_price+$Implants+$Surgeon_fees_price+$c+$b+$a+$other_price+$Enema_Simplex_price+$Consultation_fees_price+$o2_gas_price+$Dressing_fees_charge+$Baby_management_price+$Post_operative_charge+$Endotracheal_tube_price+$gas_price+$Anaesthetic_Equipment_price+$OT_Laber_room_charge+$Sucction_price+$Rylestube_price+$check+$canula_price+$Pho_price);
    }
    //echo $sub_total;
    ?>
