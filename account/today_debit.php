                    ...
                    <div class="row">
                        ...
                        <div class="right_content_area">
                            <div class="col-md-10">
                                ...
                                <form action="debit_search_by_date.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                    <table border="0" >
                                        <tr>
                                            <td style="text-align: center;"><input style="text-align: center;font-size: 12px;width: 300px;" type="text"  name="search_id" id="search_id"  class="form-control search datepicker" placeholder="Search By Date !" required></td>
                                ...
                                ?>
                                <div>
                                    <p style="color:red;font-size: 20px;">Debit for Date : <?php echo $today;?></p>
                                    <div class="container-fluid col-md-5">
                                        <div class="row">
                                            <p><b>Particulars<span style="float:right;">Taka</span></b></p>
                                            <?php
                                                $select1 = "SELECT sum(promo) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select2 = "SELECT sum(House) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select3 = "SELECT sum(Mobile) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select4 = "SELECT sum(O2) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select5 = "SELECT sum(Other_repair_fee) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select6 = "SELECT sum(Machine) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select7 = "SELECT sum(Invitation) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select8 = "SELECT sum(Variant) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select9 = "SELECT sum(Buy_Surgery_material) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select10 = "SELECT sum(ray_flim) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select11 = "SELECT sum(Electrical_Bill) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select12 = "SELECT sum(Govt_tax) FROM `debit` WHERE date = '$today'";
                                    ...
                                    <div class="col-md-5 col-md-offset-1">
                                        <div class="row">
                                            <p><b>Particulars<span style="float:right;">Taka</span></b></p>
                                            <?php
                                                $select12 = "SELECT sum(Paper) FROM `debit` WHERE date = '$today'";
                                                $exe_select12 = $conn->query($select12);
                                                while ($row = $exe_select12->fetch_assoc()){
                                                    $Paper = $row['sum(Paper)'];
                                                }
                                            ...
                                            <?php
                                                $select13 = "SELECT sum(Fuel) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select14 = "SELECT sum(Salary) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select15 = "SELECT sum(Subscription) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select16 = "SELECT sum(Consultant) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select17 = "SELECT sum(Buy_Electric_material) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select18 = "SELECT sum(Buy_Electronics_material) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select19 = "SELECT sum(Transport) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select20 = "SELECT sum(Hardware) FROM `debit` WHERE date = '$today'";
                                           ...
                                           <?php
                                                $select21 = "SELECT sum(Buy_Machine_material) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select22 = "SELECT sum(RF) FROM `debit` WHERE date = '$today'";
                                            ...
                                            <?php
                                                $select23 = "SELECT sum(Outside) FROM `debit` WHERE date = '$today'";
