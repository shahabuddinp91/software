...
$check = $_POST['check'];
    ...
    $b = $_POST['b'];
    $a = $_POST['a'];
    $ano_other = $_POST['ano_other'];
    $BLOCK_p = $_POST['BLOCK_p'];
    $ot_dresing_price = $_POST['ot_dresing_price'];
    $Implants = $_POST['Implants'];
    $Surgeon_fees_price = $_POST['Surgeon_fees_price'];
    ...
    if(!$check){
       ...
       $sub_total =  ($ano_other+$BLOCK_p+$ot_dresing_price+$Implants+$Surgeon_fees_price+$c+$b+$a+$other_price+$Enema_Simplex_price+$Consultation_fees_price+$o2_gas_price+$Dressing_fees_charge+$Baby_management_price+$Post_operative_charge+$Endotracheal_tube_price+$gas_price+$Anaesthetic_Equipment_price+$OT_Laber_room_charge+$Sucction_price+$Rylestube_price+$check+$canula_price+$Pho_price);
    }
    //echo $sub_total;
    ?>
