                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                <?php echo 'All Outdoor pharmacy List at ' . $month.' & year '.$year ?>

                                            </h2>



                                            <form action="pharmacy_search.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
                                            ...
                                            if ($count > 0) {
                                                ...
                                                while ($row = $execute_sql->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a style="font-size: 18px;" href="pharmacy/outdoor_bill_report.php?regi_id=<?php echo $row['id']; ?>"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a> |
                                                            <a style="font-size: 18px;" href="edit_pharmacy.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil-square" aria-hidden="true" title="Edit"></i></a> |
<!--                                                            <a style="font-size: 18px;" href="pharmacy/delete.php?id=<?php //echo $row['id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="Delete"></i></i></a>-->
