...
//                                                    die();
                                                ...
                                                $select_query_mobile = "SELECT * FROM `patient_entry_form` WHERE mobile ='$searching_date'";
                                            ...
                                            <?php if ($count > 0) { ?>
                                                ...
                                                while ($row = $sele->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['reg_date']; ?></td>
                                                         <td>
                                                             <a href="edit_appointment_patient.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
                                                             <a href="delete.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="Delete"></i></a>
                                                         </td>
                                                    </tr>
                                                    <?php
