                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                <?php echo 'All Admission Patient at month ' . $month.' & year '.$year; ?>

                                            </h2>



                                            <form action="admission_search.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
                                        ...
                                        <table border="1" class="table text-center" style="margin-top: 10px;">
                                            <tr class="">
                                                ...
                                                <td style="background-color: #346E99;color: #fff;">Cabin/bed no</td>
...
//echo $today;
                                            ...
                                            $select_sql = "SELECT patient_entry_form.id, patient_entry_form.patient_name, patient_entry_form.age, patient_entry_form.mobile,patient_admission_system.doctor_name,patient_admission_system.cabin_no,patient_admission_system.admission_date,patient_admission_system.status
FROM patient_entry_form
INNER JOIN patient_admission_system
ON patient_entry_form.id=patient_admission_system.reg_id where patient_admission_system.month = '$month' and patient_admission_system.year = '$year'
