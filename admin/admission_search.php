                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                $select_query = "SELECT patient_entry_form.id, patient_entry_form.patient_name, patient_entry_form.age, patient_entry_form.mobile,patient_admission_system.doctor_name,patient_admission_system.cabin_no,patient_admission_system.admission_date
FROM patient_entry_form
INNER JOIN patient_admission_system
ON patient_entry_form.id=patient_admission_system.reg_id where patient_admission_system.admission_date = '$searching_date'
ORDER BY  patient_admission_system.reg_id desc";
//                                                    echo $select_query;
//                                                    die();
...
FROM patient_entry_form
INNER JOIN patient_admission_system
ON patient_entry_form.id=patient_admission_system.reg_id where patient_admission_system.reg_id = '$searching_date'
ORDER BY  patient_admission_system.reg_id desc";
                                            ...
                                            <form action="" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
                                                        <td><input style="text-align: center;font-size: 12px;width: 300px;" value="<?php echo $searching_date; ?>" type="text"  name="selldate" id="selldate"  class="form-control datepicker" placeholder="Search By Date,ID !" required></td>
                                        ...
                                        <table border="1" class="table text-center" style="margin-top: 10px;">
                                            ...
                                            <?php if ($sell_date_count > 0) { ?>
                                                <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                    <?php echo 'All admission Patient at ' . $searching_date ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color: #346E99;color: #fff;">Cabin no</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['admission_date']; ?></td>
                                                         <td>
                                                            ...
                                                            <a style="font-size: 18px;" href="admission_edit.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil-square" aria-hidden="true" title="Edit"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
                                            ...
                                            <?php if ($count_mobile > 0) { ?>
                                                <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                    <?php echo 'Search Complete for Name no ' . $searching_date ?>
