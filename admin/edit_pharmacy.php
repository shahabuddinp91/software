            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    include '../connection/db.php';
                        $insert_sql = "SELECT * FROM `outdoor_pharmacy_p_register` WHERE id = '$id'";
    ...
    text-transform: uppercase;">Updating pathology Patient Informatica</div>
                                ...
                                $mess = '';
                                    if(isset($_POST['update'])){
                                        ...
                                        $update = "UPDATE `outdoor_pharmacy_p_register` SET `patient_name`='$patient_name',`mobile`='$patient_mobile',`age`='$age',`dr_name`='$Doctor_Name' WHERE id = '$id'";
