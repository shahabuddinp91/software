...
//                                            echo $today;
                                        ...
                                        $month=date('F');
                                                 ...
                                                 echo 'Indoor Pharmacy Bill at '.$today;
                                                 echo $delete_message;
                                                 ?>


                                            </div>
                                            <form action="output_patient_pharmacy_bill_search_by_id.php" method="post" style="padding-bottom: 10px;">
                                                <table>
                                                    <tr>
                                                        <td><input type="text" name="regid" placeholder="Registration ID !" class="form-control datepicker" required></td>
                                            ...
                                            <table border="1" class="table text-center"  style="">
                                                <tr>
                                                    <td style="background-color: #346E99; width: 60px; color: #fff;">SL No</td>
                                                    <td style="background-color: #346E99; width: 120px; color: #fff;">Registration ID</td>
                                                ...
                                                $select_query = "SELECT * FROM `pharmacy_patient_bill` WHERE date = '$today' order by regi_id desc ";
//                                            echo $select_query;
//                                                die();
                                                ...
                                                while ($row = $execute_sql->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="report_pharmacy_bill.php?regi_id=<?php echo $row['regi_id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i>Report</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
