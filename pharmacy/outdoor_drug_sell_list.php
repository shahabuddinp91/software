...
//                                            echo $today;
                                            ...
                                            <div class="" style="border-bottom: 1px solid;
                                                 ...
                                                 $today=date('m/d/Y');
                                                 echo 'All Sell Drug List ' .$today.' For outdoor';
//                                                 echo $delete_message;
                                                 $patient_id='';
                                                 ?>
                                            ...
                                            <form action="outdoor_drug_bill_process_form.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
...
<!--                                                    <td style="background-color: #346E99;color: #fff;">Action</td>-->
                                                ...
                                                $select_query="SELECT * FROM `out_drug_sell_list` WHERE date = '$today'";
//                                                echo $select_query;
//                                                die();
