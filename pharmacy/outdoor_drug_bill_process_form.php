...
//                                            echo $searching_item;
                                                $select_query_id = "SELECT * FROM `out_drug_sell_list` WHERE patient_id ='$searching_item'";
...
//                                                    die();
                                            ...
                                            <div class="panel panel-primary modal-content modal-body col-md-6" style="">
                                                ...
                                                <div class="col-md-6">
                                                        <?php
                                                    $info_select = "SELECT * FROM `out_pharmacy_bill` WHERE patient_id = '$patient_id'";
                                                ...
                                                <div class="old_info">
                                                    <table border="1" style="text-align: center; width: 450px;">
                                                        <tr>
                                                            <td style="background-color: #337AB7; width: 80px;color: #fff;">Test Bill</td>
                                                            <td style="background-color: #337AB7; width: 80px;color: #fff;">Discount</td>
                                                            <td style="background-color: #337AB7; width: 140px;color: #fff;">Bill(With discount)</td>
                                                            <td style="background-color: #337AB7; width: 140px;color: #fff;">Bill Payment</td>
                                                            <td style="background-color: #337AB7; width: 100px;color: #fff;">Bill Due</td>
                                                        </tr>
        ...
        <script>
            $(document).ready(function () {
                $('.submit_bill').on('click', function (e) {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: 'insert/outdoor_pharmacy_total_bill.php',
                        data: data
                    })
                            .done(function (m) {
                                alert(m)
