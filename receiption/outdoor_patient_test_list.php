                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                <!--<span><a href="outdoor_p_t_l_pdf.php" style="text-decoration: none; ">Save As Pdf<i class="fa fa-file-pdf-o" aria-hidden="true"></i> </a></span>--> 
...
//echo $today;
                                            ...
                                            $select_sql = "SELECT * FROM `outdoor_test` WHERE date='$today' ORDER by out_p_id DESC";
//                                            echo $select_sql;
//                                            die();
