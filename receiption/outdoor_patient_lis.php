                                    ...
                                    <div class="response">
                                        ...
                                        <div class="" style="border-bottom: 1px solid;padding-bottom: 6px;">
                                            <h2 style="color: #000;font-family: caption;font-size: 24px;margin-left: 50px;opacity: 0.6;display: inline-block;">
                                                <?php echo 'Outdoor test Patient List at ' . $today ?>

                                            </h2>



                                            <form action="outdoor_patient_list_search_by_id_name_mobile.php" method="POST" style="font-size: 15px; padding-top: 5px; padding-bottom: 5px;">
                                                <table border="0" >
                                                    <tr>
...
//echo $today;
                                            ...
                                            $select_sql = "SELECT * FROM `outdoor_test_register` WHERE date = '$today' order by id desc";
                                            ...
                                            if ($count > 0) {
                                                ...
                                                while ($row = $execute_sql->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="report_outdoor_patient_register.php?id=<?php echo $row['id']; ?>"><img src="../images/view.png" title="View" height="32" width="32" alt="View"></a>
                                                        </td>
                                                    </tr>
