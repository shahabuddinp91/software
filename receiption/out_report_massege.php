                    ...
                    <div class="row">
                        ...
                        <div class="right_content_area">
                            <div class="col-md-10">
                                ...
                                $today = date('m/d/Y');
                                ?>
                                <p style="color: red;font-size: 29px;">All Outdoor Test Report For <?php echo $today; ?></p>
                                <table id="hide" border="1" class="table text-center" style="margin-top: 10px;">
                                    ...
                                    $today = date('m/d/Y');
                                    $patient_message = '';
                                    $select_query = "SELECT * FROM `outdoor_path_message` WHERE date = '$today' and status = 'Report ok' ORDER BY id DESC";
//                                  
